          ...
          <Link href="/">
            <a>
              <svg xmlns="http://www.w3.org/2000/svg" width="100%" viewBox="0 0 600 456.9">
                ...
                <rect fill="#FFFFFF" x="131.5" width="91.7" height="319.4"/>
                <path fill="#FFFFFF" d="M355.2,93.5v225.9h-91.7V0C314.4,1,355.2,42.5,355.2,93.5z"/>
                <circle cx="425.7" cy="289.3" r="30.2" fill="#E16D4B"/>
                <path fill="#FFFFFF" d="M80.4,431.7l-0.1-58l-28.8,48h-7.3l-28.8-47.3v57.3H0v-87.6h13.4l34.8,58l34.1-58h13.4l0.1,87.6H80.4z"/>
                <path fill="#FFFFFF" d="M180.5,364.9l-31.3,72.2c-2.9,7.3-6.5,12.4-10.6,15.3s-9.2,4.4-15.1,4.4c-3.3,0-6.6-0.5-9.9-1.6c-3.3-1.1-5.9-2.6-8-4.5
                ...
                <path fill="#FFFFFF" d="M306.7,431.7l-0.1-58l-28.8,48h-7.3l-28.8-47.3v57.3h-15.5v-87.6h13.4l34.8,58l34.1-58H322l0.1,87.6H306.7z"/>
                <path fill="#FFFFFF" d="M406.8,403.3h-52.4c0.9,4.9,3.3,8.8,7.2,11.7c3.9,2.9,8.7,4.3,14.4,4.3c7.3,0,13.4-2.4,18.1-7.3l8.4,9.6
                ...
                <path fill="#FFFFFF" d="M487.4,338.9v92.8h-15v-8.6c-2.6,3.2-5.8,5.5-9.6,7.1c-3.8,1.6-8,2.4-12.6,2.4c-6.4,0-12.2-1.4-17.3-4.3
                ...
                <path fill="#FFFFFF" d="M508.7,351.2c-1.9-1.8-2.9-4-2.9-6.7c0-2.7,1-4.9,2.9-6.7c1.9-1.8,4.3-2.7,7.1-2.7c2.8,0,5.2,0.9,7.1,2.6
                  ...
                  v66.8h-15.6V364.9z"/>
                <path fill="#FFFFFF" d="M592.2,371.2c5.2,4.7,7.8,11.8,7.8,21.3v39.1h-14.8v-8.1c-1.9,2.9-4.7,5.1-8.2,6.7c-3.5,1.5-7.8,2.3-12.8,2.3
